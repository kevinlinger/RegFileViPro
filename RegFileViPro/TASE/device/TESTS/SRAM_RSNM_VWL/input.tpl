...
parameters	wpu=<wpu>       \
		...
		lpd=<lpd>	\
		wpg=<wpg>	\
		lpg=<lpg> bitline=<bitline> wlv=<wlv>	
...
export VT_PL=oceanEval("pv(\"ICell.ICellLh.MP.PX.<pModelName>\" \"vtho\" ?result 'model)")
export VT_PR=oceanEval("pv(\"ICell.ICellRh.MP.PX.<pModelName>\" \"vtho\" ?result 'model)")
export VT_NL=oceanEval("pv(\"ICell.ICellLh.MN.NX.<nModelName>\" \"vtho\" ?result 'model)")
export VT_NR=oceanEval("pv(\"ICell.ICellRh.MN.NX.<nModelName>\" \"vtho\" ?result 'model)")
export VT_TL=oceanEval("pv(\"ICell.ICellLh.MT.NX.<nModelName>\" \"vtho\" ?result 'model)")
export VT_TR=oceanEval("pv(\"ICell.ICellRh.MT.NX.<nModelName>\" \"vtho\" ?result 'model)")
}
