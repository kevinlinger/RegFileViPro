...
%load data%
load IDVD_PU/DAT/dc_dc.dat;
load IDVD_PU/DAT/dc_P1_PX_d.dat;
load IDVD_PU/DAT/dc_P2_PX_d.dat;
load IDVD_PU/DAT/dc_P3_PX_d.dat;
load IDVD_PU/DAT/dc_P4_PX_d.dat;
load IDVD_PU/DAT/dc_P5_PX_d.dat;
load IDVD_PU/DAT/dc_P5_PX_g.dat;
...
fout = fopen('IDVD_PU/data.txt', 'w');
fprintf(fout, '%e\t%e\n', [Ion Ig]'); 
fclose(fout);
%save I1,I2 values into a file
fout = fopen('IDVD_PU/modelParams.txt','w');
fprintf(fout,' %e\t%e\n',I1,I2);
fclose(fout);
...
%save and close%
print(gcf, '-depsc', 'IDVD_PU/IMG/IDVD_PU.eps');
close(gcf);
