...
%load data%
f=load('5TSRAM_Iread_dist/OUT/monteCarlo/mcdata');
...
%save and close%
print(gcf, '-depsc', '5TSRAM_Iread_dist/IMG/5TSRAM_Iread_dist.eps');
close(gcf);
...
%save and close%
print(gcf, '-depsc', '5TSRAM_Iread_dist/IMG/SRAM_Vread_dist.eps');
close(gcf);
