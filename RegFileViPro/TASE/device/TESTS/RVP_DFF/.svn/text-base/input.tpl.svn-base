...
tpHL1 = cross(v("Q1") <pvdd>/2 1 'falling) - cross(v("CLK") <pvdd>/2 1 'rising)
tpLH1 = cross(v("Q1") <pvdd>/2 1 'rising) - cross(v("CLK") <pvdd>/2 2 'rising)

tpHL2 = cross(v("Q2") <pvdd>/2 1 'falling) - cross(v("CLK") <pvdd>/2 1 'rising)
tpLH2 = cross(v("Q2") <pvdd>/2 1 'rising) - cross(v("CLK") <pvdd>/2 2 'rising)
