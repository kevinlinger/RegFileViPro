...
%load data%
load SRAM_Bfly_st/DAT/dc_pvIn.dat;
load SRAM_Bfly_st/DAT/dc_B.dat;
%f=load('SRAM_Bfly_st/monteCarlo/mcdata');
b=load('SRAM_Bfly_st/DAT/dc_B.dat');
a=load('SRAM_Bfly_st/DAT/dc_A.dat');
c=load('SRAM_Bfly_st/DAT/dc_C.dat');
d=load('SRAM_Bfly_st/DAT/dc_D.dat');
xma=<pvdd>;
xmax=xma+0.1;
...
%save and close%
print(gcf, '-depsc', 'SRAM_Bfly_st/IMG/SRAM_Bfly_st.eps');
print(gcf, '-dtiff','-r300','SRAM_Bfly_st/IMG/SRAM_Bfly_st.tif');
close(gcf);
