...
%load data%
load RSTSRAM_Ioff_Ileak_vs_VDD/DAT/dc_IOFF_in.dat;
load RSTSRAM_Ioff_Ileak_vs_VDD/DAT/dc_ILEAK_VDD_in.dat;
load RSTSRAM_Ioff_Ileak_vs_VDD/DAT/dc_ILEAK_VSS_in.dat;
load RSTSRAM_Ioff_Ileak_vs_VDD/DAT/dc_VDD.dat;
...
%save and close%
print(gcf, '-depsc', 'RSTSRAM_Ioff_Ileak_vs_VDD/IMG/RSTSRAM_Ioff_Ileak_vs_VDD.eps');
close(gcf);

%print Ioff values to file for model calculations
fout = fopen('RSTSRAM_Ioff_Ileak_vs_VDD/modelParams.txt','w');
fprintf(fout,'%e\t%e\t%e\n',1e9*dc_IOFF_in(1,1),1e9*dc_ILEAK_VDD_in(1,1),1e9*dc_ILEAK_VSS_in(1,1));
fclose(fout);
