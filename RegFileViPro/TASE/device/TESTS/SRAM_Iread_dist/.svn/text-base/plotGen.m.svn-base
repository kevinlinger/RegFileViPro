...
%load data%
f=load('SRAM_Iread_dist/OUT/monteCarlo/mcdata');
...
%save and close%
print(gcf, '-depsc', 'SRAM_Iread_dist/IMG/SRAM_Iread_dist.eps');
close(gcf);
...
%save and close%
print(gcf, '-depsc', 'SRAM_Iread_dist/IMG/SRAM_Vread_dist.eps');
close(gcf);
