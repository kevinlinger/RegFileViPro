...
%load data%
load IDVD_N/DAT/dc_dc.dat;
load IDVD_N/DAT/dc_N1_NX_d.dat;
load IDVD_N/DAT/dc_N2_NX_d.dat;
load IDVD_N/DAT/dc_N3_NX_d.dat;
load IDVD_N/DAT/dc_N4_NX_d.dat;
load IDVD_N/DAT/dc_N5_NX_d.dat;
load IDVD_N/DAT/dc_N5_NX_g.dat;
...
fout = fopen('IDVD_N/data.txt', 'w');
fprintf(fout, '%e\t%e\n', [Ion Ig]'); 
fclose(fout);
%save I1,I2 values into a file
fout = fopen('IDVD_N/modelParams.txt','w');
fprintf(fout,' %e\t%e\n',I1,I2);
fclose(fout);
...
%save and close%
print(gcf, '-depsc', 'IDVD_N/IMG/IDVD_N.eps');
close(gcf);
