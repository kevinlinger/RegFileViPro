...
%load data%
load RVP_Ion_N/DAT/dc_dc.dat;
load RVP_Ion_N/DAT/dc_N1_NX_d.dat;
load RVP_Ion_N/DAT/dc_N2_NX_d.dat;
load RVP_Ion_N/DAT/dc_N3_NX_d.dat;
load RVP_Ion_N/DAT/dc_N4_NX_d.dat;
load RVP_Ion_N/DAT/dc_N5_NX_d.dat;
load RVP_Ion_N/DAT/dc_N5_NX_g.dat;
...
Ion=I(end,5);
%get Ion in unit uA/um for VDS = VDD/2, VDD, required for Req calculations in SRAM model
...
%fout = fopen('RVP_Ion_N/data.txt', 'w');
%fprintf(fout, '%e\t%e\n', [Ion Ig]'); 
%fclose(fout);
...
%save and close%
print(gcf, '-depsc', 'RVP_Ion_N/IMG/RVP_Ion_N.eps');
close(gcf);
