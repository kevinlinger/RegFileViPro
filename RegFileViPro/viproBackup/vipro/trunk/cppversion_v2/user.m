...
tasePath = /var/home/kal5nx/TASE;

% Commands, either SWEEP, OPTIMIZE, CALCULATE
%SWEEP SAoffset 0.05 0.3 0.05 ./sweep.txt
%SWEEP PCratio 5 10 1 ./sweep_pcratio.txt
%SWEEP WLratio 1 1 1 ./sweep_wlratio3.txt
%SWEEP VDD 0.7 1.3 0.1 ./FinalReportPlots/VoltageIbm65.csv
SWEEP BitcellUpsize 5 8 1 ./thirdWeekPlots/sweep_readPorts4upsizedHIGH.csv
%SWEEP WritePorts 1 4 1 ./sweep_writePorts4.csv
%SWEEP VDD 0.7 1.3 0.1 ./secondWeekPlots/voltageSweep.csv
%SWEEP ReadPorts 1 4 1 ./thirdWeekPlots/readPortsSweep.csv
OPTIMIZE OBJECTIVE 
	   ENERGY 0 
	   DELAY 1.15
         KNOBS 
