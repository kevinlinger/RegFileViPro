...
fprintf(fid,'delay_bitcell_r\t%e\n delay_pch_r\t%e\n energy_pch_r\t%e\n energy_bitcell_r\t%e\n',delay_bitcell_r, delay_pch_r, energy_pch_r, energy_bitcell_r);


fprintf(fid,'delay_rowDecoder\t%e\n energy_rowDecoder\t%e\n energy_SA\t%e\n  delay_SA\t%e\n', delay_rowDecoder, energy_rowDecoder, energy_SA, delay_SA);


fprintf(fid,'delay_DFF\t%e\n energy_DFF_r\t%e\n energy_timing\t%e\n delay_bankSelect\t%e\n', delay_DFF, energy_DFF_r, energy_timing,  delay_bankSelect); 


fprintf(fid,'delay_bankOutput\t%e\n  read_delay\t%e\n  read_energy\t%e\n  delay_rowDecoder\t%e\n', delay_bankOutput,  read_delay,  read_energy,  delay_rowDecoder); 


fprintf(fid,'energy_rowDecoder\t%e\n  energy_timing\t%e\n  delay_DFF\t%e\n  delay_DFF_w\t%e\n  energy_DFF_w\t%e\n', energy_rowDecoder,  energy_timing,  delay_DFF,  delay_DFF_w, energy_DFF_w); 
